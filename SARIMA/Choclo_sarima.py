...
df = pd.read_csv(r"C:\Users\tamar\Documents\Capstone\Documentos Generados\ChocloNorteTimeSeries.csv", parse_dates=["fecha"])
...
df_forecast.to_csv(r"C:\Users\tamar\Documents\Capstone\Resultados ARIMA\Choclo_forecast_demanda_v2.csv", index=False)
...
ax2.set_title(f"SARIMA{ORDER}x{SEASONAL_ORDER} + log transform — Choclo", fontsize=12, fontweight="bold")
...
plt.tight_layout()
plt.savefig(r"C:\Users\tamar\Documents\Capstone\Resultados ARIMA\Choclo_prediccion_demanda_v2.png", dpi=150)
plt.close()
