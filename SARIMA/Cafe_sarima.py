...
df = pd.read_csv(r"C:\Users\tamar\Documents\Capstone\Documentos Generados\CafeBelenTimeSeries.csv", parse_dates=["fecha"])
...
plt.tight_layout()
plt.savefig(r"C:\Users\tamar\Documents\Capstone\Resultados ARIMA\Cafe_prediccion_demanda_v2.png", dpi=150)
plt.close()
