...
# producto_objetivo = "281670015"

# #poner la direccion donde tienen guardado el archivo 
# ruta_archivo = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\Dataset.csv"
...
# # opción exacta
# df_producto = df[df["Producto"] == producto_objetivo]


# print(f"\nDatos filtrados para: {producto_objetivo}")
# print(df_producto.head())

# df_producto["Fecha"] = pd.PeriodIndex(df_producto["Fecha"], freq="M")

# df_producto = df_producto.sort_values(["Sucursal", "Fecha"])

# serie = df_producto.groupby("Fecha")["Demanda"].sum()

# print("\nSerie temporal:")
# print(serie.head())

# ruta_salida = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\Dataset_CafeBelen.csv"
# df_producto.to_csv(ruta_salida, index=False, encoding="utf-8")

# print("\nDataset filtrado guardado")


# serie.to_csv(
#     r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\CafeBelen.csv",
#     encoding="utf-8"
# )
...
# #poner la direccion donde quieren que se guarde el archivo
# ruta_salida = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\CafeBelen.xlsx"
# df_producto.to_excel(ruta_salida, index=False)

# serie.to_excel(
#     r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\CafeBelen.xlsx",
# )
...
ruta_archivo = r"G:\My Drive\A capstone Clari\Datos Documentos Excel\Documentos 2021-2026\Ventas_mensuales.csv"

ruta_salida_csv = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\Producto_filtrado.csv"
ruta_serie_csv = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\Serie_temporal.csv"
ruta_salida_excel = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\Producto_filtrado.xlsx"
...
ruta_ml = r"C:\Users\tamar\OneDrive\Documentos\Python\Capstone\Documentos Generados\Serie_ML.csv"
